...
{{
var G__15836 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15836;
continue;
}
} else
...
{var pred__15840 = cljs.core._EQ_;var expr__15841 = limit;if(cljs.core.truth_(pred__15840.call(null,1,expr__15841)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15840.call(null,2,expr__15841)))
...
var G__15843 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15844 = (limit__$1 - 1);
var G__15845 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__15843;
limit__$1 = G__15844;
parts = G__15845;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___15847 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___15847))
{var replacement_15848 = temp__4124__auto___15847;buffer.append([cljs.core.str(replacement_15848)].join(''));
} else
{buffer.append(ch);
}
{
var G__15849 = (index + 1);
index = G__15849;
continue;
}
}
