...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_19333 = 0;while(true){
var m_19334 = cljs.core.async.impl.dispatch.tasks.pop();if((m_19334 == null))
{} else
{m_19334.call(null);
if((count_19333 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__19335 = (count_19333 + 1);
count_19333 = G__19335;
continue;
}
} else
{}
