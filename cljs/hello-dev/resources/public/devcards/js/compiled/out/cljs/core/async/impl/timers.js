...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_19242 = 0;while(true){
if((i_19242 < arr.length))
{(arr[i_19242] = null);
{
var G__19243 = (i_19242 + 1);
i_19242 = G__19243;
continue;
}
} else
...
{var i_19249 = (self__.level + 1);while(true){
if((i_19249 <= (new_level + 1)))
{(update[i_19249] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_19251 = 0;while(true){
if((i_19251 <= self__.level))
{var links_19252 = (update[i_19251]).forward;if(((links_19252[i_19251]) === x__$1))
{(links_19252[i_19251] = (x__$1.forward[i_19251]));
{
