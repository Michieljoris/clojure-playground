...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t19339 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t19339 = (function (val,box,meta19340){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t19339.cljs$lang$type = true;
cljs.core.async.impl.channels.t19339.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t19339";
cljs.core.async.impl.channels.t19339.cljs$lang$ctorPrWriter = (function (this__8436__auto__,writer__8437__auto__,opt__8438__auto__){return cljs.core._write.call(null,writer__8437__auto__,"cljs.core.async.impl.channels/t19339");
});
cljs.core.async.impl.channels.t19339.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t19339.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19341){var self__ = this;
var _19341__$1 = this;return self__.meta19340;
});
cljs.core.async.impl.channels.t19339.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19341,meta19340__$1){var self__ = this;
var _19341__$1 = this;return (new cljs.core.async.impl.channels.t19339(self__.val,self__.box,meta19340__$1));
});
cljs.core.async.impl.channels.__GT_t19339 = (function __GT_t19339(val__$1,box__$1,meta19340){return (new cljs.core.async.impl.channels.t19339(val__$1,box__$1,meta19340));
});
}
return (new cljs.core.async.impl.channels.t19339(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_19342 = self__.takes.pop();if((taker_19342 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19342))
{var take_cb_19343 = cljs.core.async.impl.protocols.commit.call(null,taker_19342);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19343,taker_19342,this$__$1){
return (function (){return take_cb_19343.call(null,null);
});})(take_cb_19343,taker_19342,this$__$1))
);
} else
{}
{
