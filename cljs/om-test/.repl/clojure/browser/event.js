...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj9118 = {};return obj9118;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__4920__auto__ = this$;if(and__4920__auto__)
...
{var x__5559__auto__ = (((this$ == null))?null:this$);return (function (){var or__4932__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__5559__auto__)]);if(or__4932__auto__)
{return or__4932__auto__;
} else
{var or__4932__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__4932__auto____$1)
...
return (function (p__9119){var vec__9120 = p__9119;var k = cljs.core.nth.call(null,vec__9120,(0),null);var v = cljs.core.nth.call(null,vec__9120,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__9121){var vec__9122 = p__9121;var k = cljs.core.nth.call(null,vec__9122,(0),null);var v = cljs.core.nth.call(null,vec__9122,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
