...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj6369 = {};return obj6369;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__4926__auto__ = this$;if(and__4926__auto__)
...
{var x__5565__auto__ = (((this$ == null))?null:this$);return (function (){var or__4938__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__5565__auto__)]);if(or__4938__auto__)
{return or__4938__auto__;
} else
{var or__4938__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__4938__auto____$1)
...
return (function (p__6370){var vec__6371 = p__6370;var k = cljs.core.nth.call(null,vec__6371,(0),null);var v = cljs.core.nth.call(null,vec__6371,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__6372){var vec__6373 = p__6372;var k = cljs.core.nth.call(null,vec__6373,(0),null);var v = cljs.core.nth.call(null,vec__6373,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
