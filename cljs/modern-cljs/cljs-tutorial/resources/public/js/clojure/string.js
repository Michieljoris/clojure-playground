...
{var pred__5925 = cljs.core._EQ_;var expr__5926 = limit;if(cljs.core.truth_(pred__5925.call(null,1,expr__5926)))
...
var G__5928 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__5929 = (limit__$1 - 1);
var G__5930 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5928;
limit__$1 = G__5929;
parts = G__5930;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___5932 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___5932))
{var replacement_5933 = temp__4090__auto___5932;buffer.append([cljs.core.str(replacement_5933)].join(''));
} else
{buffer.append(ch);
}
{
