...
{{
var G__18380 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18380;
continue;
}
} else
...
{var pred__18384 = cljs.core._EQ_;var expr__18385 = limit;if(cljs.core.truth_(pred__18384.call(null,1,expr__18385)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__18384.call(null,2,expr__18385)))
...
var G__18387 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__18388 = (limit__$1 - 1);
var G__18389 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__18387;
limit__$1 = G__18388;
parts = G__18389;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___18391 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___18391))
{var replacement_18392 = temp__4124__auto___18391;buffer.append([cljs.core.str(replacement_18392)].join(''));
} else
{buffer.append(ch);
}
{
var G__18393 = (index + 1);
index = G__18393;
continue;
}
}
