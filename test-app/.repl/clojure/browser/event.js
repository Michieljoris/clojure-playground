...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj10949 = {};return obj10949;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7007__auto__ = this$;if(and__7007__auto__)
...
{var x__7656__auto__ = (((this$ == null))?null:this$);return (function (){var or__7019__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__7656__auto__)]);if(or__7019__auto__)
{return or__7019__auto__;
} else
{var or__7019__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7019__auto____$1)
...
return (function (p__10950){var vec__10951 = p__10950;var k = cljs.core.nth.call(null,vec__10951,(0),null);var v = cljs.core.nth.call(null,vec__10951,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__10952){var vec__10953 = p__10952;var k = cljs.core.nth.call(null,vec__10953,(0),null);var v = cljs.core.nth.call(null,vec__10953,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
