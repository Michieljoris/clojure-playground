...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj11899 = {};return obj11899;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7257__auto__ = this$;if(and__7257__auto__)
...
{var x__7906__auto__ = (((this$ == null))?null:this$);return (function (){var or__7269__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__7906__auto__)]);if(or__7269__auto__)
{return or__7269__auto__;
} else
{var or__7269__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7269__auto____$1)
...
return (function (p__11900){var vec__11901 = p__11900;var k = cljs.core.nth.call(null,vec__11901,(0),null);var v = cljs.core.nth.call(null,vec__11901,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__11902){var vec__11903 = p__11902;var k = cljs.core.nth.call(null,vec__11903,(0),null);var v = cljs.core.nth.call(null,vec__11903,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
