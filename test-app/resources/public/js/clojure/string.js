...
{{
var G__10971 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10971;
continue;
}
} else
...
{var pred__10975 = cljs.core._EQ_;var expr__10976 = limit;if(cljs.core.truth_(pred__10975.call(null,(1),expr__10976)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10975.call(null,(2),expr__10976)))
...
var G__10978 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10979 = (limit__$1 - (1));
var G__10980 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__10978;
limit__$1 = G__10979;
parts = G__10980;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10982 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10982))
{var replacement_10983 = temp__4124__auto___10982;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10983)));
} else
{buffer.append(ch);
}
{
var G__10984 = (index + (1));
index = G__10984;
continue;
}
}
