...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14154 = (0);while(true){
var m_14155 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14155 == null))
{} else
{m_14155.call(null);
if((count_14154 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14156 = (count_14154 + (1));
count_14154 = G__14156;
continue;
}
} else
{}
