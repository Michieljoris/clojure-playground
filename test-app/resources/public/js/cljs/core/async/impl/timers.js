...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14074 = (0);while(true){
if((i_14074 < arr.length))
{(arr[i_14074] = null);
{
...
{var i_14081 = (self__.level + (1));while(true){
if((i_14081 <= (new_level + (1))))
{(update[i_14081] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14083 = (0);while(true){
if((i_14083 <= self__.level))
{var links_14084 = (update[i_14083]).forward;if(((links_14084[i_14083]) === x__$1))
{(links_14084[i_14083] = (x__$1.forward[i_14083]));
{
var G__14085 = (i_14083 + (1));
i_14083 = G__14085;
continue;
}
} else
{{
var G__14086 = (i_14083 + (1));
i_14083 = G__14086;
continue;
}
}
