...
reagent.impl.component.do_render = (function do_render(c){var _STAR_current_component_STAR_9273 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = c;
var f = (c["cljsRender"]);var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"f","f",43394975,null)))))))})());var p = (c["props"]);var res = ((((c["componentFunction"]) == null))?f.call(null,c):(function (){var argv = (p["argv"]);var n = cljs.core.count.call(null,argv);var G__9274 = n;switch (G__9274) {
case (1):
return f.call(null);
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_9273;
}});
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__9277 = (((key instanceof cljs.core.Keyword))?key.fqn:null);switch (G__9277) {
case "componentWillUnmount":
return ((function (G__9277){
...
return ((function (G__9277){
return (function (nextprops,nextstate){var or__7446__auto__ = reagent.impl.util._STAR_always_update_STAR_;if(cljs.core.truth_(or__7446__auto__))
...
{return (function() { 
var G__9279__delegate = function (args){var c = this;return cljs.core.apply.call(null,f,c,args);
};
...
{var G__9282 = f;(G__9282["__reactDontBind"] = true);
return G__9282;
} else
{return f;
}
...
{var wrap = reagent.impl.component.custom_wrapper.call(null,key,f);if(cljs.core.truth_((function (){var and__7434__auto__ = wrap;if(cljs.core.truth_(and__7434__auto__))
{return f;
} else
...
{}
var or__7446__auto__ = wrap;if(cljs.core.truth_(or__7446__auto__))
{return or__7446__auto__;
} else
...
reagent.impl.component.wrap_funs = (function wrap_funs(fun_map){var render_fun = (function (){var or__7446__auto__ = new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__7446__auto__))
{return or__7446__auto__;
} else
{return new cljs.core.Keyword(null,"render","render",-1408033454).cljs$core$IFn$_invoke$arity$1(fun_map);
}
})();var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,render_fun))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(("Render must be a function, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun))))+"\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"render-fun","render-fun",-1209513086,null)))))))})());var name = (function (){var or__7446__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__7446__auto__))
{return or__7446__auto__;
} else
{var or__7446__auto____$1 = (render_fun["displayName"]);if(cljs.core.truth_(or__7446__auto____$1))
...
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__9284 = o;(G__9284[cljs.core.name.call(null,k)] = v);
return G__9284;
}),{},m);
});
...
return (function() { 
var G__9285__delegate = function (args){return as_component.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
