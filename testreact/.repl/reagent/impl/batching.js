...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__7446__auto__ = (w["requestAnimationFrame"]);if(cljs.core.truth_(or__7446__auto__))
{return or__7446__auto__;
} else
{var or__7446__auto____$1 = (w["webkitRequestAnimationFrame"]);if(cljs.core.truth_(or__7446__auto____$1))
{return or__7446__auto____$1;
} else
{var or__7446__auto____$2 = (w["mozRequestAnimationFrame"]);if(cljs.core.truth_(or__7446__auto____$2))
{return or__7446__auto____$2;
} else
{var or__7446__auto____$3 = (w["msRequestAnimationFrame"]);if(cljs.core.truth_(or__7446__auto____$3))
{return or__7446__auto____$3;
} else
...
var n__8316__auto__ = a.length;var i = (0);while(true){
if((i < n__8316__auto__))
{var c_9287 = (a[i]);if(cljs.core.truth_((c_9287["cljsIsDirty"])))
{(c_9287["forceUpdate"])();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__8023__auto__,writer__8024__auto__,opt__8025__auto__){return cljs.core._write.call(null,writer__8024__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(c){var G__9290 = c;var G__9290__$1 = (((G__9290 == null))?null:(G__9290["props"]));var G__9290__$2 = (((G__9290__$1 == null))?null:(G__9290__$1["argv"]));return G__9290__$2;
});
...
reagent.impl.batching.dispose = (function dispose(c){var G__9292_9293 = (c["cljsRatom"]);var G__9292_9294__$1 = (((G__9292_9293 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__9292_9293));return reagent.impl.batching.mark_rendered.call(null,c);
});
