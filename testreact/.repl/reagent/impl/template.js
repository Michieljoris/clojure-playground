...
{return (function() { 
var G__9295__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__7446__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__7446__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__9298 = o;(G__9298[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__9298;
}),{},x);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__9299){var vec__9301 = p__9299;var id = cljs.core.nth.call(null,vec__9301,(0),null);var class$ = cljs.core.nth.call(null,vec__9301,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_9302 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_9302 === "key")))
{(o[pname_9302] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__9305 = jsprops;(G__9305["defaultValue"] = value);
(G__9305["value"] = null);
(G__9305["onChange"] = ((function (G__9305,on_change,value){
return (function (p1__9303_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9303_SHARP_);
});})(G__9305,on_change,value))
);
return G__9305;
}
});
...
reagent.impl.template.wrapped_should_update = (function wrapped_should_update(c,nextprops,nextstate){var or__7446__auto__ = reagent.impl.util._STAR_always_update_STAR_;if(cljs.core.truth_(or__7446__auto__))
{return or__7446__auto__;
} else
{var a1 = (c["props"]["argv"]);var a2 = (nextprops["argv"]);return cljs.core.not.call(null,reagent.impl.util.equal_args.call(null,a1,a2));
}
});
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__9307 = spec;(G__9307["componentDidUpdate"] = ((function (G__9307){
return (function (){var c = this;return reagent.impl.template.input_did_update.call(null,c);
});})(G__9307))
);
(G__9307["componentWillUnmount"] = ((function (G__9307){
return (function (){var c = this;return reagent.impl.batching.dispose.call(null,c);
});})(G__9307))
);
return G__9307;
});
reagent.impl.template.wrap_component = (function wrap_component(comp,extras,name){var input_QMARK_ = reagent.impl.template.input_component_QMARK_.call(null,comp);var input_setup = ((input_QMARK_)?reagent.impl.template.input_render_setup:null);var spec = {"displayName": (function (){var or__7446__auto__ = name;if(cljs.core.truth_(or__7446__auto__))
{return or__7446__auto__;
} else
{return "ComponentWrapper";
}
})(), "shouldComponentUpdate": ((function (input_QMARK_,input_setup){
return (function (p1__9308_SHARP_,p2__9309_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__9308_SHARP_,p2__9309_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__9311 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__9311,(0),null);var id = cljs.core.nth.call(null,vec__9311,(1),null);var class$ = cljs.core.nth.call(null,vec__9311,(2),null);var comp = ((React["DOM"])[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__7446__auto__ = id;if(cljs.core.truth_(or__7446__auto__))
{return or__7446__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__9313 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__9313,(0),null);var id_class = cljs.core.nth.call(null,vec__9313,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = {"level": level, "argv": v};var k_9314 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__9315 = (((k_9314 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_9314);if((k_SINGLEQUOTE__9315 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__9315);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__8316__auto___9316 = a.length;var i_9317 = (0);while(true){
if((i_9317 < n__8316__auto___9316))
{(a[i_9317] = reagent.impl.template.as_component.call(null,(a[i_9317]),level_SINGLEQUOTE_));
{
