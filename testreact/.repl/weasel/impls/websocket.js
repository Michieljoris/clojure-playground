...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj13765 = {};return obj13765;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__7434__auto__ = this$;if(and__7434__auto__)
...
{var x__8083__auto__ = (((this$ == null))?null:this$);return (function (){var or__7446__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__8083__auto__)]);if(or__7446__auto__)
{return or__7446__auto__;
} else
{var or__7446__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__7446__auto____$1)
...
return (function (p__13766){var vec__13767 = p__13766;var k = cljs.core.nth.call(null,vec__13767,(0),null);var v = cljs.core.nth.call(null,vec__13767,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
