...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj19190 = {};return obj19190;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__15188__auto__ = this$;if(and__15188__auto__)
...
{var x__15837__auto__ = (((this$ == null))?null:this$);return (function (){var or__15200__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__15837__auto__)]);if(or__15200__auto__)
{return or__15200__auto__;
} else
{var or__15200__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__15200__auto____$1)
...
return (function (p__19191){var vec__19192 = p__19191;var k = cljs.core.nth.call(null,vec__19192,(0),null);var v = cljs.core.nth.call(null,vec__19192,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__19193){var vec__19194 = p__19193;var k = cljs.core.nth.call(null,vec__19194,(0),null);var v = cljs.core.nth.call(null,vec__19194,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
