...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj17118 = {};return obj17118;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__11483__auto__ = this$;if(and__11483__auto__)
...
{var x__12132__auto__ = (((this$ == null))?null:this$);return (function (){var or__11495__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__12132__auto__)]);if(or__11495__auto__)
{return or__11495__auto__;
} else
{var or__11495__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__11495__auto____$1)
...
return (function (p__17119){var vec__17120 = p__17119;var k = cljs.core.nth.call(null,vec__17120,(0),null);var v = cljs.core.nth.call(null,vec__17120,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
