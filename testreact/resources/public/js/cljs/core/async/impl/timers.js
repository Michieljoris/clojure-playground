...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_21701 = (0);while(true){
if((i_21701 < arr.length))
{(arr[i_21701] = null);
{
...
{var i_21708 = (self__.level + (1));while(true){
if((i_21708 <= (new_level + (1))))
{(update[i_21708] = self__.header);
{
var G__21709 = (i_21708 + (1));
i_21708 = G__21709;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_21710 = (0);while(true){
if((i_21710 <= self__.level))
{var links_21711 = (update[i_21710]).forward;if(((links_21711[i_21710]) === x__$1))
{(links_21711[i_21710] = (x__$1.forward[i_21710]));
{
var G__21712 = (i_21710 + (1));
i_21710 = G__21712;
continue;
}
} else
{{
var G__21713 = (i_21710 + (1));
i_21710 = G__21713;
continue;
}
}
