...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__11496__auto__ = (w["requestAnimationFrame"]);if(cljs.core.truth_(or__11496__auto__))
{return or__11496__auto__;
} else
{var or__11496__auto____$1 = (w["webkitRequestAnimationFrame"]);if(cljs.core.truth_(or__11496__auto____$1))
{return or__11496__auto____$1;
} else
{var or__11496__auto____$2 = (w["mozRequestAnimationFrame"]);if(cljs.core.truth_(or__11496__auto____$2))
{return or__11496__auto____$2;
} else
{var or__11496__auto____$3 = (w["msRequestAnimationFrame"]);if(cljs.core.truth_(or__11496__auto____$3))
{return or__11496__auto____$3;
} else
...
var n__12366__auto__ = a.length;var i = (0);while(true){
if((i < n__12366__auto__))
{var c_17153 = (a[i]);if(cljs.core.truth_((c_17153["cljsIsDirty"])))
{(c_17153["forceUpdate"])();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__12073__auto__,writer__12074__auto__,opt__12075__auto__){return cljs.core._write.call(null,writer__12074__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(c){var G__17156 = c;var G__17156__$1 = (((G__17156 == null))?null:(G__17156["props"]));var G__17156__$2 = (((G__17156__$1 == null))?null:(G__17156__$1["argv"]));return G__17156__$2;
});
...
reagent.impl.batching.dispose = (function dispose(c){var G__17158_17159 = (c["cljsRatom"]);var G__17158_17160__$1 = (((G__17158_17159 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__17158_17159));return reagent.impl.batching.mark_rendered.call(null,c);
});
