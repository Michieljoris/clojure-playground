...
{return (function() { 
var G__17161__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
G__17161.cljs$lang$applyTo = (function (arglist__17162){
var args = cljs.core.seq(arglist__17162);
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__11496__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__11496__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__17164 = o;(G__17164[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__17164;
}),{},x);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__17165){var vec__17167 = p__17165;var id = cljs.core.nth.call(null,vec__17167,(0),null);var class$ = cljs.core.nth.call(null,vec__17167,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_17168 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_17168 === "key")))
{(o[pname_17168] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__17171 = jsprops;(G__17171["defaultValue"] = value);
(G__17171["value"] = null);
(G__17171["onChange"] = ((function (G__17171,on_change,value){
return (function (p1__17169_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__17169_SHARP_);
});})(G__17171,on_change,value))
);
return G__17171;
}
});
...
reagent.impl.template.wrapped_should_update = (function wrapped_should_update(c,nextprops,nextstate){var or__11496__auto__ = reagent.impl.util._STAR_always_update_STAR_;if(cljs.core.truth_(or__11496__auto__))
{return or__11496__auto__;
} else
{var a1 = (c["props"]["argv"]);var a2 = (nextprops["argv"]);return cljs.core.not.call(null,reagent.impl.util.equal_args.call(null,a1,a2));
}
});
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__17173 = spec;(G__17173["componentDidUpdate"] = ((function (G__17173){
return (function (){var c = this;return reagent.impl.template.input_did_update.call(null,c);
});})(G__17173))
);
(G__17173["componentWillUnmount"] = ((function (G__17173){
return (function (){var c = this;return reagent.impl.batching.dispose.call(null,c);
});})(G__17173))
);
return G__17173;
});
reagent.impl.template.wrap_component = (function wrap_component(comp,extras,name){var input_QMARK_ = reagent.impl.template.input_component_QMARK_.call(null,comp);var input_setup = ((input_QMARK_)?reagent.impl.template.input_render_setup:null);var spec = {"displayName": (function (){var or__11496__auto__ = name;if(cljs.core.truth_(or__11496__auto__))
{return or__11496__auto__;
} else
{return "ComponentWrapper";
}
})(), "shouldComponentUpdate": ((function (input_QMARK_,input_setup){
return (function (p1__17174_SHARP_,p2__17175_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__17174_SHARP_,p2__17175_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__17177 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__17177,(0),null);var id = cljs.core.nth.call(null,vec__17177,(1),null);var class$ = cljs.core.nth.call(null,vec__17177,(2),null);var comp = ((React["DOM"])[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__11496__auto__ = id;if(cljs.core.truth_(or__11496__auto__))
{return or__11496__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__17179 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__17179,(0),null);var id_class = cljs.core.nth.call(null,vec__17179,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = {"level": level, "argv": v};var k_17180 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__17181 = (((k_17180 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_17180);if((k_SINGLEQUOTE__17181 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__17181);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__12366__auto___17182 = a.length;var i_17183 = (0);while(true){
if((i_17183 < n__12366__auto___17182))
{(a[i_17183] = reagent.impl.template.as_component.call(null,(a[i_17183]),level_SINGLEQUOTE_));
{
