...
reagent.impl.component.do_render = (function do_render(c){var _STAR_current_component_STAR_17139 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = c;
var f = (c["cljsRender"]);var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"f","f",43394975,null)))))))})());var p = (c["props"]);var res = ((((c["componentFunction"]) == null))?f.call(null,c):(function (){var argv = (p["argv"]);var n = cljs.core.count.call(null,argv);var G__17140 = n;switch (G__17140) {
case (1):
return f.call(null);
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_17139;
}});
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__17143 = (((key instanceof cljs.core.Keyword))?key.fqn:null);switch (G__17143) {
...
return ((function (G__17143){
return (function (nextprops,nextstate){var or__11496__auto__ = reagent.impl.util._STAR_always_update_STAR_;if(cljs.core.truth_(or__11496__auto__))
...
{return (function() { 
var G__17145__delegate = function (args){var c = this;return cljs.core.apply.call(null,f,c,args);
};
var G__17145 = function (var_args){
var args = null;if (arguments.length > 0) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__17145__delegate.call(this,args);};
G__17145.cljs$lang$maxFixedArity = 0;
G__17145.cljs$lang$applyTo = (function (arglist__17146){
var args = cljs.core.seq(arglist__17146);
return G__17145__delegate(args);
});
...
{var G__17148 = f;(G__17148["__reactDontBind"] = true);
return G__17148;
} else
{return f;
}
...
{var wrap = reagent.impl.component.custom_wrapper.call(null,key,f);if(cljs.core.truth_((function (){var and__11484__auto__ = wrap;if(cljs.core.truth_(and__11484__auto__))
{return f;
} else
...
{}
var or__11496__auto__ = wrap;if(cljs.core.truth_(or__11496__auto__))
{return or__11496__auto__;
} else
...
reagent.impl.component.wrap_funs = (function wrap_funs(fun_map){var render_fun = (function (){var or__11496__auto__ = new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__11496__auto__))
{return or__11496__auto__;
} else
{return new cljs.core.Keyword(null,"render","render",-1408033454).cljs$core$IFn$_invoke$arity$1(fun_map);
}
})();var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,render_fun))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(("Render must be a function, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun))))+"\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"render-fun","render-fun",-1209513086,null)))))))})());var name = (function (){var or__11496__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__11496__auto__))
{return or__11496__auto__;
} else
{var or__11496__auto____$1 = (render_fun["displayName"]);if(cljs.core.truth_(or__11496__auto____$1))
...
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__17150 = o;(G__17150[cljs.core.name.call(null,k)] = v);
return G__17150;
}),{},m);
});
...
return (function() { 
var G__17151__delegate = function (args){return as_component.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
...
var args = cljs.core.seq(arglist__17152);
