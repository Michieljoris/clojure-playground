...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj16981 = {};return obj16981;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__11483__auto__ = this$;if(and__11483__auto__)
...
{var x__12132__auto__ = (((this$ == null))?null:this$);return (function (){var or__11495__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__12132__auto__)]);if(or__11495__auto__)
{return or__11495__auto__;
} else
{var or__11495__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__11495__auto____$1)
...
return (function (p__16982){var vec__16983 = p__16982;var k = cljs.core.nth.call(null,vec__16983,(0),null);var v = cljs.core.nth.call(null,vec__16983,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__16984){var vec__16985 = p__16984;var k = cljs.core.nth.call(null,vec__16985,(0),null);var v = cljs.core.nth.call(null,vec__16985,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
