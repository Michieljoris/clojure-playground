...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_21781 = (0);while(true){
var m_21782 = cljs.core.async.impl.dispatch.tasks.pop();if((m_21782 == null))
{} else
{m_21782.call(null);
if((count_21781 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__21783 = (count_21781 + (1));
count_21781 = G__21783;
continue;
}
} else
{}
