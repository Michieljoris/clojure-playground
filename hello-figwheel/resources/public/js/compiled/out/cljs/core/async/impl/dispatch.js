...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12906 = 0;while(true){
var m_12907 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12907 == null))
{} else
{m_12907.call(null);
if((count_12906 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12908 = (count_12906 + 1);
count_12906 = G__12908;
continue;
}
} else
{}
