...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12815 = 0;while(true){
if((i_12815 < arr.length))
{(arr[i_12815] = null);
{
...
{var i_12822 = (self__.level + 1);while(true){
if((i_12822 <= (new_level + 1)))
{(update[i_12822] = self__.header);
{
var G__12823 = (i_12822 + 1);
i_12822 = G__12823;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12824 = 0;while(true){
if((i_12824 <= self__.level))
{var links_12825 = (update[i_12824]).forward;if(((links_12825[i_12824]) === x__$1))
{(links_12825[i_12824] = (x__$1.forward[i_12824]));
{
