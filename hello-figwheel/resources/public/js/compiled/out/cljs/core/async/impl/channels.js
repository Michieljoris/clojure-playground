...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12912 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12912 = (function (val,box,meta12913){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12912.cljs$lang$type = true;
cljs.core.async.impl.channels.t12912.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12912";
cljs.core.async.impl.channels.t12912.cljs$lang$ctorPrWriter = (function (this__4048__auto__,writer__4049__auto__,opt__4050__auto__){return cljs.core._write.call(null,writer__4049__auto__,"cljs.core.async.impl.channels/t12912");
});
cljs.core.async.impl.channels.t12912.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12912.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12914){var self__ = this;
var _12914__$1 = this;return self__.meta12913;
});
cljs.core.async.impl.channels.t12912.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12914,meta12913__$1){var self__ = this;
var _12914__$1 = this;return (new cljs.core.async.impl.channels.t12912(self__.val,self__.box,meta12913__$1));
});
cljs.core.async.impl.channels.__GT_t12912 = (function __GT_t12912(val__$1,box__$1,meta12913){return (new cljs.core.async.impl.channels.t12912(val__$1,box__$1,meta12913));
});
}
return (new cljs.core.async.impl.channels.t12912(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12915 = self__.takes.pop();if((taker_12915 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12915))
{var take_cb_12916 = cljs.core.async.impl.protocols.commit.call(null,taker_12915);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12916,taker_12915,this$__$1){
return (function (){return take_cb_12916.call(null,null);
});})(take_cb_12916,taker_12915,this$__$1))
);
} else
{}
{
