...
{{
var G__10168 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10168;
continue;
}
} else
...
{var pred__10172 = cljs.core._EQ_;var expr__10173 = limit;if(cljs.core.truth_(pred__10172.call(null,1,expr__10173)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10172.call(null,2,expr__10173)))
...
var G__10175 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10176 = (limit__$1 - 1);
var G__10177 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10175;
limit__$1 = G__10176;
parts = G__10177;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10179 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10179))
{var replacement_10180 = temp__4124__auto___10179;buffer.append([cljs.core.str(replacement_10180)].join(''));
} else
{buffer.append(ch);
}
{
var G__10181 = (index + 1);
index = G__10181;
continue;
}
}
