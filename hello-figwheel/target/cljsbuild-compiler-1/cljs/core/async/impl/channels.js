...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20133 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20133 = (function (val,box,meta20134){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20133.cljs$lang$type = true;
cljs.core.async.impl.channels.t20133.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20133";
cljs.core.async.impl.channels.t20133.cljs$lang$ctorPrWriter = (function (this__4048__auto__,writer__4049__auto__,opt__4050__auto__){return cljs.core._write(writer__4049__auto__,"cljs.core.async.impl.channels/t20133");
});
cljs.core.async.impl.channels.t20133.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20133.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20135){var self__ = this;
var _20135__$1 = this;return self__.meta20134;
});
cljs.core.async.impl.channels.t20133.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20135,meta20134__$1){var self__ = this;
var _20135__$1 = this;return (new cljs.core.async.impl.channels.t20133(self__.val,self__.box,meta20134__$1));
});
cljs.core.async.impl.channels.__GT_t20133 = (function __GT_t20133(val__$1,box__$1,meta20134){return (new cljs.core.async.impl.channels.t20133(val__$1,box__$1,meta20134));
});
}
return (new cljs.core.async.impl.channels.t20133(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_20136 = self__.takes.pop();if((taker_20136 == null))
{} else
{if(taker_20136.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_20137 = taker_20136.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_20137,taker_20136,this$__$1){
return (function (){return (take_cb_20137.cljs$core$IFn$_invoke$arity$1 ? take_cb_20137.cljs$core$IFn$_invoke$arity$1(null) : take_cb_20137.call(null,null));
});})(take_cb_20137,taker_20136,this$__$1))
);
} else
{}
{
