...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_20036 = 0;while(true){
if((i_20036 < arr.length))
{(arr[i_20036] = null);
{
var G__20037 = (i_20036 + 1);
i_20036 = G__20037;
continue;
}
} else
...
{var i_20043 = (self__.level + 1);while(true){
if((i_20043 <= (new_level + 1)))
{(update[i_20043] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_20045 = 0;while(true){
if((i_20045 <= self__.level))
{var links_20046 = (update[i_20045]).forward;if(((links_20046[i_20045]) === x__$1))
{(links_20046[i_20045] = (x__$1.forward[i_20045]));
{
var G__20047 = (i_20045 + 1);
i_20045 = G__20047;
continue;
}
} else
{{
var G__20048 = (i_20045 + 1);
i_20045 = G__20048;
continue;
}
}
