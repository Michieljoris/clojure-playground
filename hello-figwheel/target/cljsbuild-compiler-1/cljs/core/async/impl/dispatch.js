...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20127 = 0;while(true){
var m_20128 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20128 == null))
{} else
{(m_20128.cljs$core$IFn$_invoke$arity$0 ? m_20128.cljs$core$IFn$_invoke$arity$0() : m_20128.call(null));
if((count_20127 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20129 = (count_20127 + 1);
count_20127 = G__20129;
continue;
}
} else
{}
